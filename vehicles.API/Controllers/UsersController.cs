    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> index()
        {
            return View(await _context.Users
                .Include(x => x.DocumentType).Include(u => u.Vehicles).Where(x => x.UserType == UserType.User).ToListAsync());
        }
        ...
        public async Task<IActionResult> AddVehicle(VehicleViewModel vehicleViewModel)
        {
                ...
                {
                    imageId = await _blobHelper.UploadBlobAsync(vehicleViewModel.ImageFile, "vehiclesphotos");
                }
